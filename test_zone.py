...
# Receives ID. Also checks if length is within a range and shows error if outside of it.
def getID():
    print('ID')
    id_student = getInt()
...
# Receives age. Also checks if value is within a range and shows error if outside of it.
def getAge():
    print('Age')
    age = getInt()
